...
# Cell 2: Code Configurations (at the top)
cells.append({
    "cell_type": "code",
...
# Cell 4: User-Level Metric Evaluation Function
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Cell 5: Main calculation loop (Iterating through W = [3, 5, 7], fixing MCS=15 to solve instability)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Cell 6: Visualizing "All Hubs Topology" (Combined 2x2 grid, optimized layout, removed text labels)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Cell 7: Visualizing "User Metrics Distribution" (Two separate 1x4 horizontal grids, optimized sizes)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Cell 8: Plotting Qualitative Grid Results (Unifying legend at the bottom)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {},
...
# Compile the notebook structure
notebook = {
    "cells": cells,
    "metadata": {
        "kernelspec": {
...
# Write notebook to experiments.ipynb
notebook_path = "experiments.ipynb"
with open(notebook_path, "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print(f"Jupyter notebook {notebook_path} created successfully.")
